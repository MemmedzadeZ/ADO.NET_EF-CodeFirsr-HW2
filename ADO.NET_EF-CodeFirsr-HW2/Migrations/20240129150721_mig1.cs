    ...
    public partial class mig1 : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_GroupLecture", x => x.Id);
                    table.ForeignKey(
                        name: "FK_GroupLecture_Groups_GroupId",
                        column: x => x.GroupId,
                        principalTable: "Groups",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_GroupLecture_Lectures_LectureId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_GroupLecture_GroupId",
                table: "GroupLecture",
                column: "GroupId");

            migrationBuilder.CreateIndex(
                name: "IX_GroupLecture_LectureId",
                table: "GroupLecture",
                column: "LectureId");
